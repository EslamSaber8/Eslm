...
router.route("/").get(getUsers).post(uploadMultipleImages, createUserValidator, createUser)
router.route("/:id").get(getUserValidator, getUser).put(uploadMultipleImages, updateUserValidator, updateUser).delete(deleteUserValidator, deleteUser)
